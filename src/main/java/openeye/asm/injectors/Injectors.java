...
public class Injectors {
	...
	public static void setupInjectors(Multimap<String, MethodCodeInjector> injectors) {
...

		{
			...
			String logHandlerName = getClassName(LOG_AGENT_CLS);
...

		{
			...
			MethodMatcher matcher = new MethodMatcher(tileEntityName, methodType.getDescriptor(), "createAndLoadEntity", "func_70317_c");
